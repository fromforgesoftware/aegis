-- Lossy down: unified anchor ids stay unified (old code reads
-- organization.resource_id, which remains valid). The projection reverts to
-- the bindings-only definition.
